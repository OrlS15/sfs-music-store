			...
			<div class="hero-middle">
				<h1>
					È ora di farti <span style="position: relative">sentire<span
						class="green-underline"></span></span>!
					<p style="font-size: 13px; margin: 5px 0 10px 0">
						<i>Compra qui il tuo nuovo strumento</i>
					</p>
				</h1>
	...
	<section class="categorie" id="categorie">
		<div class="categorie-content">
				...
				<div class="cards-wrapper">
					<div class="card-categoria">
						<div class="card-categoria-info">
							<p>Bassi</p>
							<a href="${pageContext.request.contextPath}/negozio.jsp?cat=basso">VISUALIZZA</a>
						</div>
					...
					<div class="card-categoria">
						<div class="card-categoria-info">
							<p>Chitarre</p>
							<a href="${pageContext.request.contextPath}/negozio.jsp?cat=chitarra">VISUALIZZA</a>
						</div>
					...
					<div class="card-categoria">
						<div class="card-categoria-info">
							...
							<a href="${pageContext.request.contextPath}/negozio.jsp?cat=strumenti-a-corda">VISUALIZZA</a>
						</div>
					...
					<div class="card-categoria">
						<div class="card-categoria-info">
							<p>Batterie</p>
							<a href="${pageContext.request.contextPath}/negozio.jsp?cat=batteria">VISUALIZZA</a>
						</div>
					...
					<div class="card-categoria">
						<div class="card-categoria-info">
							<p>Fiati</p>
							<a href="${pageContext.request.contextPath}/negozio.jsp?cat=fiato">VISUALIZZA</a>
						</div>
					...
					<div class="card-categoria">
						<div class="card-categoria-info">
							<p>Pianoforti</p>
							<a href="${pageContext.request.contextPath}/negozio.jsp?cat=pianoforte">VISUALIZZA</a>
						</div>
						<img src="${pageContext.request.contextPath}/assets/images/categorie/pianoforte.png" alt="basso" />
					</div>
				</div>
				<span class="span-divider"></span>
			</div>
			<div class="brands-wrapper">
				...
				<img src="${pageContext.request.contextPath}/assets/images/brands/bcrich.png" alt="bcrich" />
				<img src="${pageContext.request.contextPath}/assets/images/brands/epiphone.png" alt="epiphone" />
				<img src="${pageContext.request.contextPath}/assets/images/brands/yamaha.png" alt="yamaha" />
				<img src="${pageContext.request.contextPath}/assets/images/brands/gibson.png" alt="gibson" />
				<img src="${pageContext.request.contextPath}/assets/images/brands/schechter.png" alt="schechter" />
			</div>
		</div>
	</section>
