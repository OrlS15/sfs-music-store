			...
			<form action="negozio.jsp" method="GET">
				<div class="filtro">
					...
					<div class="filtro-content">
						<div>
							<input type="radio" id="filtro_nuovo" name="c" value="nuovo"
								<%=f_condizioni.equals("nuovo") ? "checked" : ""%> /> <label
								for="filtro_nuovo">Nuovo</label>
						</div>
						<div>
							<input type="radio" id="filtro_warehouse" name="c"
								value="warehouse"
								<%=f_condizioni.equals("warehouse") ? "checked" : ""%> /> <label
								for="filtro_warehouse">Warehouse</label>
						</div>
					</div>
				</div>
				...
				<div class="filtro">
					...
					<div class="filtro-content">
						<div>
							<input type="checkbox" id="categoria_chitarre" name="cat"
								value="chitarra"
								<%=f_categorie.contains("chitarra") ? "checked" : ""%> /> <label
								for="categoria_chitarre">Chitarre</label>
						</div>
						<div>
						...
						<div>
							<input type="checkbox" id="categoria_strumento-a-corde"
								name="cat" value="strumento-a-corda"
								<%=f_categorie.contains("strumento-a-corda") ? "checked" : ""%> />
							<label for="categoria_strumento-a-corde">Strumenti a
								corda</label>
						</div>
						<div>
