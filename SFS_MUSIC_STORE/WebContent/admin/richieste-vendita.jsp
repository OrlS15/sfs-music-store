<%@page import="beans.ProductWarehouseBean"%>
...
<%
	...
	if(pbs==null) {
		response.sendRedirect("richieste-vendita");
		return;
	}
%>
...
<html lang="it">
  <head>	
    ...
    />
    <title>SFS Music Store - Richieste Vendita</title>
  </head>
	          ...
	          <div class="card-prodotto">
	            ...
	            <div class="info-prodotto">
	              ...
	              <div class="prezzo-prodotto">
	                ...
	                <form action="richieste-vendita?action=reject&id=<%=pb.getId_richiesta_vendita() %>" class="form-delete-product" method="POST">
